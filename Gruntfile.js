module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            dist: {
                options: {
                    browserifyOptions: {
                        ...
                        standalone: 'MitchAllen.-marchio-lambda-post'
                        // standalone: 'mitchallen.-marchio-lambda-post'
                    },
                ...
                files: {
                   ...
                   "./dist/marchio-lambda-post.js": ["./modules/index.js"]
                   // For non-standalone, use ./browser.js instead.
                   // "./dist/marchio-lambda-post.js": ["./browser.js"]
                }
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    './dist/marchio-lambda-post.min.js': ['./dist/marchio-lambda-post.js']
                }
            }
        },
